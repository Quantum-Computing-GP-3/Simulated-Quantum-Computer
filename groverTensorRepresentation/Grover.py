...
def launch(n, marked_state):
    ...
    # -------------------------- GROVER'S ALGORITHM --------------------------
    # First step is to initialise a quantum register of n qubits to the 0th
    # state.
    ...
    # We now apply the Grover and Oracle gates in order to amplify the needed
    # state.
    ...
    # We also create plot of the quantum register approaching the state we
    # wish to amplify.
